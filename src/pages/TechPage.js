            ...
            if (base.id === techState.basedPlatformId) {
              return (
                  <ListGroup.Item key={base.id}>
                    Название:{base.Наименование}
                    <ListGroup.Item>Мощность:{base.Мощность}</ListGroup.Item>
                    <ListGroup.Item>Грузоподъемность:{base.Грузоподъемность}</ListGroup.Item>
                    <ListGroup.Item>Скорость:{base.Скорость}</ListGroup.Item>
                    <ListGroup.Item>Расход:{base.Расход}</ListGroup.Item>
                    <ListGroup.Item>Масса:{base.Масса}</ListGroup.Item>
                  </ListGroup.Item>
              );
            }
